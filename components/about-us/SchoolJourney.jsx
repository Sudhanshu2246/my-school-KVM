        ...
        <div className="relative border-l-4 border-pink-500 pl-8">
          {journey.map((item, index) => (
            <div key={index} className="mb-12 relative">
              {/* Dot */}
              <div className="absolute -left-5 top-1 w-6 h-6 bg-pink-500 rounded-full border-4 border-white"></div>

              {/* Content */}
              <div className="p-6 rounded-xl shadow-md hover:scale-105 transition transform bg-white">
